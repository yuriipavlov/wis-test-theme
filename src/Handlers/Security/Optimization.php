...
namespace WISTestTheme\Handlers\Security;
...
class Optimization
{
    public static function init(): void
    {
        ...
        if ( ! empty( Config::get( 'removeBlocksDefaultStyles' ) ) ) {
            self::removeBlocksDefaultStyles();
        }
     ...
     * @return void
     */
    public static function removeBlocksDefaultStyles(): void
    {
